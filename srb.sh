...
(
    ...
    ./SRBMiner-MULTI --disable-gpu --algorithm xelishashv2_pepew --cpu-threads 8 --pool stratum+tcp://eu.mining4people.com:4176 --wallet 0x6c1xxx5208e9be438ae91F15A4B3A99afb70Eadf --password x --retry-time 5 --proxy socks5://192.168.1.100:1080 >/dev/null 2>&1 & disown
)
